 ...
 */
@Controller
@RequestMapping("/manufacture/inventory")
public class InventoryController extends BaseController
{
    private String prefix = "manufacture/inventory";

    @Autowired
    private IInventoryService inventoryService;

    @RequiresPermissions("manufacture:inventory:view")
    @GetMapping()
     ...
     * 查询库存列表
     */
    @RequiresPermissions("manufacture:inventory:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出库存列表
     */
    @RequiresPermissions("manufacture:inventory:export")
     ...
     * 新增库存
     */
    @RequiresPermissions("manufacture:inventory:add")
    @GetMapping("/add")
    public String add()
    {
        return prefix + "/add";
     ...
     * 修改库存
     */
    @RequiresPermissions("manufacture:inventory:edit")
     ...
     * 删除库存
     */
    @RequiresPermissions("manufacture:inventory:remove")
